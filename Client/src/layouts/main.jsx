    ...
    <>
      <div className="nav-container">
        ...
        <Link as={RouterLink} to="#">
          ...
          <div className="btn-container">
            <svg className="nav-btn" xmlns="http://www.w3.org/2000/svg" height="48" width="48"><path d="M15.9 34.45H6.25q-1 0-1.475-.875Q4.3 32.7 4.9 31.85l6.95-10h-1.6q-1 0-1.3-.85-.3-.85.3-1.75l6.85-9.9q.55-.65 1.4-.65.85 0 1.4.65l5.1 7.3 5.1-7.3q.55-.65 1.4-.65.85 0 1.4.65l6.9 9.9q.55.9.25 1.75-.3.85-1.3.85H36.2l6.9 10q.6.85.125 1.725-.475.875-1.475.875H32.1v6.35q0 .7-.425 1.15-.425.45-1.175.45-.65 0-1.125-.475T28.9 40.8v-6.35h-9.8v6.35q0 .7-.425 1.15-.425.45-1.175.45-.65 0-1.125-.475T15.9 40.8Zm14.75-1.75h10.8l-8.7-12.6h4.4l-6.65-9.5-5.35 7.65.75 1q.5.9.225 1.75t-1.275.85H23.2Zm-24.1 0h21.9l-8.7-12.6h4.4l-6.65-9.5-6.65 9.5h4.45Zm0 0h8.75-4.45 13.3-4.4 8.7Zm24.1 0H23.2h2.925-.975 12-4.4 8.7Zm-1.75 1.75h3.2-3.2Zm-.2 0Z" /></svg>
          </div>
        </Link>
